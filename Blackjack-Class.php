...
class Deck
{
  ...
  public function buildDeck($suits, $cards) {
    $this->suits = mt_rand(0, count($suits) - 1);
    $this->cards = mt_rand(0,count($cards) - 1);
  	return $buildDeck->cards[$randomValue] . " " . $suit[$randomSuit] . PHP_EOL;
  	echo($buildDeck);
  }
  ...
  public function getHandTotal($hand) {
    // todo
  }

  // draw a card from the deck into a hand
  // pass by reference (both hand and deck passed in are modified)
  public function drawCard(&$hand, &$deck) {
  }
  ...
  public function echoHand($hand, $name, $hidden = false) {
    // todo
  }
}
